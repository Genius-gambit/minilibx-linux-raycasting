...
void	make_line(t_vars *vars, float x, float y, double angle)
{
	// double	x1;
	// double	y1;
	// double	ang;
	...
	// y1 = vars->p.y_co;
	// ang = angle;
	// while ((int)x1 != (int)x && (int)y1 != (int)y)
	// {
	// 	x1 += cos(ang);
	// 	y1 += sin(ang);
	// 	draw_point(vars, x1 * 87, y1 * 87);
	// }
	/*double	m;
	double	x1;
	double	x2;
